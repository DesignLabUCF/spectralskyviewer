...
Data directory must be organized in a very specific way.
See https://spectralskylight.github.io/RadianceEstimationData for example data

Context menu -> Graph Resolution applies to plotting of spectral radiance. 1 = every nanometer, 2 = every other, etc. Adjusting this can significantly improve performance of plotting.

Pixel Region / Weighting - Refers to the pixel kernel used determine the final pixel color during export. The color can be seen in the bottom-right of the canvas.
